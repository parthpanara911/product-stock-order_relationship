                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="responsive-logo">
                            <a href="#" class="header-logo">
                                <img src="{{asset('/images/laravel.png')}}" class="mobile-logo logo-1" alt="logo">
                                <!-- <img src="../assets/images/brand/logo.png" class="mobile-logo dark-logo-1" alt="logo"> -->
                            </a>
                        </div>
                        <!-- sidebar-toggle-->
                        <a class="logo-horizontal " href="">
                            <img src="{{asset('/images/laravel.png')}}" class="header-brand-img desktop-logo" alt="logo">
                                    ...
                                    <div class="d-flex order-lg-2">
                                        ...
                                        <div class="dropdown d-md-flex notifications">
                                            ...
                                            <!-- <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow ">
													...
													<a href="notify.html" class="dropdown-item text-center p-3 text-muted">View all Notification</a>
												</div> -->
                                        </div>
                                        <!-- NOTIFICATIONS -->
                                        <div class="dropdown d-md-flex message">
                                            ...
                                            <!-- <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
													...
													<div class="dropdown-divider m-0"></div>
													<a href="chat.html" class="dropdown-item text-center p-3 text-muted">See all Messages</a>
												</div> -->
                                        </div>
                                        <!-- MESSAGE-BOX -->
                                        <div class="dropdown d-md-flex profile-1">
                                            <!-- <a href="javascript:void(0);" data-bs-toggle="dropdown" class="nav-link leading-none d-flex px-1">
                                                <span>
                                                    <img src="assets/images/aprofilelogo.png" alt="profile-user" class="avatar  profile-user brround cover-image">
                                                </span>
                                            </a> -->
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div class="drop-heading">
                                                    <!-- <div class="text-center">
                                                    <h5 class="text-dark mb-0">Parth Panara</h5>
