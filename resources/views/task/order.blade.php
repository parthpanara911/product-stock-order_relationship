                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <div>
                                <h1 class="page-title display-6">Order Details</h1>
                                <!-- <ol class="breadcrumb">
                        ...
                        <div class="row">
                            ...
                            <div class="container mt-4">
                                <div class="d-flex justify-content-end">
                                    <a href="{{route('order.create')}}" class="btn btn-success mb-2">Add Order</a>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$order->totalprize}}</td>
                                                <td>{{$order->date}}</td>
                                                <td>
                                                <a class="btn btn-danger delete text-white" data-id="{{$order->id}}">Delete</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
